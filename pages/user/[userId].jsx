...
const userId = ({data}) => {
  const {user} = useContext(UserContext)
    return (
        <Layout title={`${data[0]?.fullName}, User at Trickzone Blog`} thumb={data[0]?.photo || 'https://www.pngall.com/wp-content/uploads/5/User-Profile-PNG.png'} desc={data[0]?.about}>
        {
